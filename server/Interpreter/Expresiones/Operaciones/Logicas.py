    ...
    def getValor(self, driver, ts):
        ...
        if tipo_exp1 != None:
            if tipo_exp1 == Tipos.BOOLEAN and tipo_exp2 == Tipos.BOOLEAN:
                ...
                raise Exception(f'Error Semantico, No se pueden comparar {tipo_exp1} con {tipo_exp2}, linea {self.exp2.linea}, columna {self.exp2.columna}')
        else:
            if tipo_exp2 == Tipos.BOOLEAN:
                ...
                raise Exception(f'Error Semantico, No se puede negar {tipo_exp2}, linea {self.exp2.linea}, columna {self.exp2.columna}')